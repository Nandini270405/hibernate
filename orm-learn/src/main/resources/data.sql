...
-- Employee Data
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (1, 'John Doe', 75000.00, true, '1990-05-15', 1);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (2, 'Jane Smith', 82000.00, true, '1992-08-22', 1);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (3, 'Bob Johnson', 45000.00, false, '1995-12-10', 2);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (4, 'Alice Brown', 95000.00, true, '1988-03-30', 3);
...
-- User Data
INSERT INTO users (us_id, us_name) VALUES (1, 'Admin');

-- Attempt Data
INSERT INTO attempt (at_id, at_us_id, at_date) VALUES (1, 1, '2026-07-19');
...
INSERT INTO question (qn_id, qn_text) VALUES (3, 'The HTML document itself begins with <html> and ends </html>. State True of False');
INSERT INTO question (qn_id, qn_text) VALUES (4, 'Choose the right option to store text value value in a variable');
